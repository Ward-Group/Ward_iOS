...
public enum WardFonts {
  ...
  public enum GmarketSans {
    ...
    public static let medium = FontConvertible(name: "GmarketSansMedium", family: "Gmarket Sans", path: "GmarketSansMedium.otf")
    public static let all: [FontConvertible] = [bold, light, medium]
  }
